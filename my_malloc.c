...
void my_free(void * ptr){
	...
	if(((void*)memory<=ptr)&&(ptr<=(void*)(memory+20000))){
		...
		printf("please provide a valid pointer allocated by my malloc\n");
}
...
void * my_malloc(size_t noOfBytes){
	...
	if((curr->size)==noOfBytes){
		...
		result = NULL;
		printf("Sorry.No suffient memory to allocate\n");
		return result;
	}
}
...
int main(){
	...
	printf("Allocation and Deallocation is done sucessfully\n");
